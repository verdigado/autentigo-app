...
abstract final class CustomColors {
  static const MaterialColor klee =
      MaterialColor(_kleePrimaryValue, <int, Color>{
    50: Color(0xFFE5F3EB),
  ...
  static const MaterialColor tanne =
      MaterialColor(_tannePrimaryValue, <int, Color>{
    50: Color(0xFFD5EEE6),
  ...
  static const MaterialColor sonne =
      MaterialColor(_sonnePrimaryValue, <int, Color>{
    600: Color(_sonnePrimaryValue),
  });

  static const int _himmelPrimaryValue = 0xFF0BA1DD;
  static const MaterialColor himmel =
      MaterialColor(_himmelPrimaryValue, <int, Color>{
  ...
  static const MaterialColor grashalm =
      MaterialColor(_grashalmPrimaryValue, <int, Color>{
